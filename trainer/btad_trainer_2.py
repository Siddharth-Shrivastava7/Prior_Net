...
from .base_trainer_2 import BaseTrainer
...
class Trainer(BaseTrainer):
    ...
    def train(self):
        writer = SummaryWriter(comment="reak_fake_tensor_unet_foc_aug_rcrop")
        ...
        self.loader, _ = dataset_2.init_source_dataset(self.config)#, source_list=self.config.src_list)
